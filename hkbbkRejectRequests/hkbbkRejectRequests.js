...
exports.handler = function(event, context) {
    ...
    async.waterfall([
        function Step1(step1Callback) {
            ...
            console.log("Get market item with id: " + event.marketId.S);
            var getItemParams = {
                ...
                "ProjectionExpression": "donor, demandStatus, donorFullname, credit, supplicant, marketId",
        ...
        function step2(demand,step2Callback){
            ...
            if (demand.demandStatus.S !== "REQUEST"){
                ...
                var updateDemandParams = {
                        ...
                        "UpdateExpression": "set demandStatus = :demandStatus, updateAt = :updateAt",
        ...
        function step4(demand, now, step4Callback){
            ...
            var data = {donor: demand.donor.S, fullname: demand.donorFullname.S};
            var notice = {userId:demand.supplicant.S,createdAt:now,alert:"您向" + demand.donorFullname.S +"的1個書本請求沒有被接納， +" + demand.credit.N.toString() + "\ue022 已回贈。",type:"REJECTED", data: data };
                            ...
                            var payload = {
                                "APNS_SANDBOX": {
                                    "aps": {
                                        ...
                                        "data" : {
                                            "donor" : demand.donor.S,
                                            "fullname" : demand.donorFullname.S
                                        }
                                    }
                                }
                            };
